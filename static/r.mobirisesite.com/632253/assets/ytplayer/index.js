...
EventEmitter.prototype.on = function(e, t) {
    ...
    if ("object" == typeof this.events[e])
        for (a = (i = this.events[e].slice()).length, t = 0; t < a; t++) i[t].apply(this, s)
...
var loadScript = function(e, t, i) {
        return new Promise(((a, s) => {
            ...
            for (var [l, n] of (r.async = !0, r.src = e, Object.entries(t || {}))) r.setAttribute(l, n);
            r.onload = () => {
...
YouTubePlayer = class extends EventEmitter {
    constructor(e, t) {
        ...
        i.id ? this._id = i.id : this._id = i.id = "ytplayer-" + Math.random().toString(16).slice(2, 8), this._opts = Object.assign({
            width: 640,
            height: 360,
            autoplay: !1,
            captions: void 0,
            ...
            this._api = t, this.videoId && this.load(this.videoId, this._autoplay, this._start)
        }))
    }
    indexOf(e, t) {
        for (var i = 0, a = e.length, s = -1, r = !1; i < a && !r;) e[i] === t && (s = i, r = !0), i++;
        return s
    }
    load(e, t = !1, i = 0) {
        this.destroyed || (this._startOptimizeDisplayEvent(), this._optimizeDisplayHandler("center, center"), this.videoId = e, this._autoplay = t, this._start = i, this._api && (this._player ? this._ready && (t ? this._player.loadVideoById(e, i) : this._player.cueVideoById(e, i)) : this._createPlayer(e)))
    }
    play() {
        ...
        !this.replayInterval.find((e => e.iframeParent === this._player.i.parentNode)) && e && this.replayInterval.push({
            ...
            interval: setInterval((() => {
                if (this._player.getCurrentTime() >= this._player.getDuration() - Number(e)) {
                    this.seek(0);
                    for (const [e, t] of this.replayInterval.entries()) Object.hasOwnProperty.call(this.replayInterval, e) && (clearInterval(this.replayInterval[e].interval), this.replayInterval.splice(e, 1))
                }
            }), 1e3 * Number(e))
        })
    }
        ...
        if (t) {
            ...
            if (a) {
                const s = window.getComputedStyle(a),
                    ...
                    n = 1.7,
                    o = t;
                e.width = l, e.height = r + 80, o.style.width = e.width + "px", o.style.height = Math.ceil(parseFloat(o.style.width, 10) / n) + "px", o.style.marginTop = Math.ceil(-(parseFloat(o.style.height, 10) - e.height) / 2) + "px", o.style.marginLeft = 0;
                const h = parseFloat(o.style.height, 10) < e.height;
                h && (o.style.height = e.height + "px", o.style.width = Math.ceil(parseFloat(o.style.height, 10) * n) + "px", o.style.marginTop = 0, o.style.marginLeft = Math.ceil(-(parseFloat(o.style.width, 10) - e.width) / 2) + "px");
                for (const t in i)
    ...
    stopReplay(e) {
        for (const [t, i] of this.replayInterval.entries()) Object.hasOwnProperty.call(this.replayInterval, t) && e === this.replayInterval[t].iframeParent && (clearInterval(this.replayInterval[t].interval), this.replayInterval.splice(t, 1))
    }
    setVolume(e) {
    ...
    _loadIframeAPI(e) {
        ...
        loadIframeAPICallbacks.push(e), Array.from(document.getElementsByTagName("script")).some((e => e.src === YOUTUBE_IFRAME_API_SRC)) || loadScript(YOUTUBE_IFRAME_API_SRC).catch((e => {
    ...
    _onError(e) {
        if (!this.destroyed) {
            var t = e.data;
            if (t !== YOUTUBE_ERROR.HTML5_ERROR) return t === YOUTUBE_ERROR.UNPLAYABLE_1 || t === YOUTUBE_ERROR.UNPLAYABLE_2 || t === YOUTUBE_ERROR.NOT_FOUND || t === YOUTUBE_ERROR.INVALID_PARAM ? this.emit("unplayable", this.videoId) : void this._destroy(new Error("YouTube Player Error. Unknown error code: " + t))
        }
    }
    _startOptimizeDisplayEvent() {
        this._resizeListener || (this._resizeListener = () => this._optimizeDisplayHandler("center, center"), window.addEventListener("resize", this._resizeListener))
    }
    _onTimeupdate() {
