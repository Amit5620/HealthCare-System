! function(n, e) {
    ...
    function p(n, e, t, u, c, s, d, f, l, p, g, m, v, h, x) {
        ...
        function z(n) {
            if (!(k = "mousedown" === n.type) || 0 === n.button) {
                var e, r = a(u.get(), d.get()) >= 2,
                    o = k || !r,
                    i = (e = n.target.nodeName || "", !(w.indexOf(e) > -1)),
                    c = r || k && i;
                B = !0, s.pointerDown(n), E.set(u), u.set(d), p.useBaseMass().useSpeed(80),
                    function() {
                        var n = k ? document : t;
                        T.add(n, "touchmove", O).add(n, "touchend", N).add(n, "mousemove", O).add(n, "mouseup", N)
                    }(), M.set(s.readPoint(n, y)), S.set(s.readPoint(n, b)), v.emit("pointerDown"), o && (L = !1), c && n.preventDefault()
            }
        }
        ...
        function O(n) {
            ...
            !L && c && (L = !0), f.start(), u.add(e.applyTo(c)), n.preventDefault()
        }
        ...
        function N() {
            var n = g.byDistance(0, !1).index !== m.get(),
                ...
                b = f ? 10 : P,
                w = f ? 1 + 2.5 * o : 1;
            d && !k && (L = !0), I = !1, B = !1, T.removeAll(), p.useSpeed(y ? 9 : b).useMass(w), l.distance(r, !c), k = !1, v.emit("pointerUp")
        }
    ...
    function g(n, e, t) {
        var r, a = (r = Math.pow(10, 2), function(n) {
        ...
        var m = {
            ...
            seek: function(e) {
                ...
                return d = i(s.get()), s.normalize().multiply(t).subtract(u),
                    function(n) {
                        n.divide(l), c.add(n)
                    }(s), m
            },
    ...
    function y(n, e, t, r, o, i, a, u) {
        var s, d = c(r),
            f = c(r).reverse(),
            l = (s = o[0] - 1, m(g(f, s), "end")).concat(function() {
                var n = e - o[0] - 1;
    ...
    function b(n, e, t) {
        ...
        return {
            addActivationEvents: function(n) {
                o.add(document, "keydown", u, !1), n.forEach(c)
            },
            removeAllEvents: i
        }
    }
    ...
    function M(n, r, i, a, u) {
        var f, l = a.align,
            ...
            H = V.slideSizes,
            R = V.slideSizesWithGaps,
            j = x(O, U, N, L, k, P),
            G = j.snaps,
            q = j.snapsAligned,
            W = -s(G) + s(R),
            X = function(n, t, r, o, i) {
                var a = e(-t + n, r[0]),
                    u = o.map(a.constrain);
                return {
            ...
            $ = function(n) {
                ...
                T || un.scrollBounds.constrain(un.dragHandler.pointerDown()), un.scrollBody.seek(en).update();
                var n = un.scrollBody.settle(en);
                n && !un.dragHandler.pointerDown() && (un.animation.stop(), u.emit("settle")), n || u.emit("scroll"), T && (un.scrollLooper.loop(un.scrollBody.direction()), un.slideLooper.loop()), un.translate.to(nn), un.animation.proceed()
            })),
            _ = J[K.get()],
            nn = o(_),
            en = o(_),
                ...
                dragHandler: p(O, z, n, en, D, function(n, e) {
                    ...
                    return {
                        pointerDown: function(n) {
                            var r = l(n, t);
                            return i.set(r), u.set(r), e.measure(i.get())
                        },
    ...
    return function(e, t) {
        var o, i, a, u, c, s, d = function() {
            ...
            g = (o = function() {
                ...
                window.clearTimeout(i), i = window.setTimeout(o, 500) || 0
            }),
            m = D,
            v = d.on,
            h = d.off,
        ...
        function E(t) {
            if (function() {
                    ...
                    c = t, s = Array.prototype.slice.call(c.children), n = getComputedStyle(e, ":before").content, u = {
                        get: function() {
                            try {
                ...
                }(), y = n({}, y, t), b = n({}, y, u.get()), a = M(e, c, s, b, d), p.add(window, "resize", g), a.translate.to(a.location), w = a.axis.measureSize(e.getBoundingClientRect()), b.loop) {
                if (!a.slideLooper.canLoop()) return C(), E({
                    loop: !1
                });
                a.slideLooper.loop()
            }
            b.draggable && c.offsetParent && s.length && (a.dragHandler.addActivationEvents(), b.draggableClass && l(e, b.draggableClass), b.draggingClass && d.on("pointerDown", A).on("pointerUp", A)), s.length && a.slideFocus.addActivationEvents(s), b.selectedClass && (T(), d.on("select", T).on("pointerUp", T)), x || (setTimeout((function() {
                return d.emit("init")
            }), 0), x = !0)
        }
        ...
        function C() {
            a.dragHandler.removeAllEvents(), a.slideFocus.removeAllEvents(), a.animation.stop(), p.removeAll(), a.translate.clear(), a.slideLooper.clear(), f(e, b.draggableClass), s.forEach((function(n) {
        ...
        function I(n, e, t) {
            a.scrollBody.useBaseMass().useSpeed(e ? 100 : b.speed), x && a.scrollTo.index(n, t || 0)
        }
