(() => {
    ...
    function r(e, r, a = 0) {
        const l = t.findIndex((t => t.carouselId === e)); - 1 !== l && r && (t[l].intervalId || (t[l].intervalId = setInterval((() => {
            if (!document.hidden) {
                const r = t.findIndex((t => t.carouselId === e));
                if (-1 === r) return;
                if (1 !== t[r].embla.scrollProgress()) return void t[r].embla.scrollNext();
    ...
    function a(e, r) {
        return new Promise(((a, l) => {
            ...
            const c = EmblaCarousel(i, r),
                d = function(e, t, r) {
                    return () => {
                        r.canScrollPrev() ? e.removeAttribute("disabled") : e.setAttribute("disabled", "disabled"), r.canScrollNext() ? t.removeAttribute("disabled") : t.setAttribute("disabled", "disabled")
                    }
                }(s, u, c);
            ! function(e, t, r) {
                e.addEventListener("click", r.scrollPrev, !1), t.addEventListener("click", r.scrollNext, !1)
            }(s, u, c), c.on("select", d), c.on("init", d), t.push({
                carouselId: o,
                embla: c,
                intervalId: null
            }), a(c)
    ...
    function n(e) {
        const r = t.findIndex((t => t.carouselId === e)); - 1 !== r && ("embla" in t[r] && t[r].embla.destroy(), clearInterval(t[r].intervalId), t.splice(r, 1))
    }
    ...
    document.querySelector("html").classList.contains("is-builder") && u ? i(document).on("add.cards", (t => {
        if (!i(t.target).hasClass("mbr-embla") || s) return Promise.resolve();
        const u = t.target.getAttribute("id");
        n(u);
        const c = l(t.target.querySelector(".embla")),
            d = o(c, e),
            b = Object.assign(c, d);
        return b.draggable = !1, a(t.target, b).then((e => {
            e.reInit(b), r(u, b.autoPlay, b.autoPlayInterval), s = !0, setTimeout((() => {
                s = !1
            }), 0)
        }))
    })).on("delete.cards", (e => {
    ...
    })) : void 0 === window.initCarouseMultiplePlugin && (window.initCarouseMultiplePlugin = !0, document.querySelectorAll(".mbr-embla").forEach((t => {
