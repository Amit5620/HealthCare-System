! function() {
    ...
    function d(e) {
        ...
        return "*" === (e = void 0 === e ? "*" : e.toLowerCase()) ? t = Object.values(n) : e in n && t.push(n[e]), !(!t.length || !navigator.userAgent.match(new RegExp(t.join("|"), "i")))
    }
    o && (e = jQuery), t = e ? e("html").hasClass("is-builder") : document.querySelector("html").classList.contains("is-builder"), Element.prototype.parents = function(e) {
        for (var t = [], n = this, o = void 0 !== e; null !== (n = n.parentElement);) n.nodeType === Node.ELEMENT_NODE && (o && !n.matches(e) || t.push(n));
        return t
        ...
        function o() {
            !n && e.offsetHeight <= window.outerHeight ? (e.style.zIndex = "-999", e.style.position = "fixed", e.style.bottom = "0", e.style.width = t.offsetWidth + "px", t.style.marginBottom = e.offsetHeight + "px") : (e.style.zIndex = "", e.style.position = "", e.style.bottom = "", e.style.width = "", t.style.marginBottom = "")
        }
        return o(), window.addEventListener("resize", (function() {
            o()
        })), window.addEventListener("load", (function() {
            o()
        })), e
    }, n = "smartresize", window[n] = function(e) {
        var t, o, r, i, a = new CustomEvent(n);
        return e ? this.addEventListener("resize", (t = e, function() {
            var e = this,
                n = arguments;
            i ? clearTimeout(i) : r && t.apply(e, n), i = setTimeout((function() {
    ...
    if (s((function() {
            ...
            if (document.querySelector("html").classList.add(d() ? "mobile" : "desktop"), window.addEventListener("scroll", (function() {
                ...
                if (window.addEventListener("update.parallax", (function(e) {
                    ...
                    e(document).on("add.cards", (function(t) {
                        ...
                        if ("bg" === n) switch (i = t.target, jarallax && jarallax(i, "destroy"), i.style.position = "", e(t.target).find(".mbr-background-video-preview").remove(), e(t.target).find(".mbr-background-video").remove(), r) {
                            case "type":
                            case "parallax":
            ...
            function g(e) {
                r(e, "[data-bg-video]").forEach((function(e) {
                    ...
                    a.classList.add("mbr-background-video-preview"), a.style.display = "none", a.style.backgroundSize = "cover", a.style.backgroundPosition = "center", e.querySelector(".mbr-background-video-preview") || e.childNodes[0].before(a);
                    if (i && (/youtu\.?be/g.test(i[3]) || /vimeo/g.test(i[3]))) {
                        if (i && /youtu\.?be/g.test(i[3])) {
                            ...
                            s.onload = function() {
                                if (120 === (s.naturalWidth || s.width)) {
                                    ...
                                    switch (n) {
                                        ...
                                        case "sddefault.jpg":
                                            ...
                                            break;
                                        default:
                                            t && (a.style.backgroundImage = 'url("images/no-video.jpg")', a.style.display = "block")
                                    }
                                } else a.style.backgroundImage = 'url("' + s.src + '")', a.style.display = "block";
                                e.querySelector(".mbr-background-video") && e.querySelector(".mbr-background-video").remove();
                                var o = document.createElement("div");
                                const l = document.createElement("div"),
                                    c = document.createElement("div"),
                                    d = document.createElement("div");
                                d.classList.add("mbr-video-foreground"), d.appendChild(o), c.appendChild(d), l.appendChild(c), o.classList.add("mbr-background-video");
                                ...
                                l.style.overflow = "hidden", l.style.position = "absolute", l.style.width = "100%", l.style.height = "100%", l.style.top = "0", l.style.left = "0", c.style.background = "#000", c.style.top = "0", c.style.right = "0", c.style.bottom = "0", c.style.left = "0", d.style.position = "absolute", d.style.top = "0", d.style.left = "0", d.style.width = "100%", d.style.height = "100%", d.style.pointerEvents = "none", o.style.marginTop = "0", o.style.maxWidth = "initial", o.style.transitionProperty = "opacity", o.style.transitionDuration = "1000ms", o.style.pointerEvents = "none", o.style.position = "absolute", o.style.top = "0", o.style.left = "0", o.style.width = "100%", o.style.height = "100%", o.parentNode.style.overflow = "hidden", o.style.transform = "scale(1.2)", h.load(i[6], !0, r), h.play(), h.setLoop(!0), h.mute(), h.on("ended", (() => h.play())),
                                    function(e, t) {
                                        let n = {},
                                            o = {};
                                        o.width = window.outerWidth, o.height = window.outerHeight;
                                        let r = e._opts.width / e._opts.height;
                                        n.width = o.width, n.height = Math.ceil(n.width / r), n.marginTop = Math.ceil(-(n.height - o.height) / 2), n.height < o.height && (n.height = o.height, n.width = Math.ceil(n.height * r), n.marginLeft = Math.ceil(-(n.width - o.width) / 2)), e.setSize(n.width, n.height)
                                    }(h)
                            }, s.setAttribute("src", l)
                        } else if (i && /vimeo/g.test(i[3])) {
                            var c = new XMLHttpRequest;
                            c.open("GET", "https://vimeo.com/api/v2/video/" + i[6] + ".json", !0), c.onreadystatechange = function() {
                                if (4 === this.readyState)
                                    if (this.status >= 200 && this.status < 400) {
                                        var e = JSON.parse(this.responseText);
                                        a.style.backgroundImage = 'url("' + e[0].thumbnail_large + '")', a.style.display = "block"
                                    } else t && (a.style.backgroundImage = 'url("images/no-video.jpg")', a.style.display = "block")
                            }, c.send(), c = null, e.querySelector(".mbr-background-video") && e.querySelector(".mbr-background-video").remove(), (f = document.createElement("div")).classList.add("mbr-background-video");
                            ...
                            m.style.overflow = "hidden", u.element.style.pointerEvents = "none", u.element.style.marginLeft = "-" + (u.element.scrollWidth - m.scrollWidth) / 2 + "px", u.element.style.minHeight = "100vh", u.element.style.minWidth = "177.77vh"
                        }
                    } else if (t) a.style.backgroundImage = 'url("images/video-placeholder.jpg")', a.style.display = "block";
                    else if (!t) {
                        var f = document.createElement("video"),
                            h = document.createElement("source");
                        f.append(h), e.childNodes[1].before(f), h.src = n, f.autoplay = !0, f.loop = !0, f.muted = !0, f.setAttribute("muted", ""), f.playsinline = !0, f.setAttribute("playsinline", ""), f.style.position = "absolute", f.style.left = "50%", f.style.top = "50%", f.style.bottom = "0", f.style.right = "0", f.style.minWidth = "100%", f.style.minHeight = "100%", f.style.transform = "translateX(-50%) translateY(-50%)";
                        let t = "";
                        e.querySelector(".mbr-fallback-image") && (t = window.getComputedStyle(e.querySelector(".mbr-fallback-image")).backgroundImage, t = t.match(/\((.*?)\)/)[1].replace(/('|")/g, ""), f.setAttribute("poster", t)), f.parentNode.style.overflow = "hidden"
                    }
                }))
            }
            if (window.addEventListener("scroll", (function() {
                    ...
                    if (f = e, h) {
                        ...
                        t ? n != h.fixed && (p ? (h.fixed = n, h.elm.classList.toggle("is-fixed")) : m = setTimeout((function() {
                            h.fixed = n, h.elm.classList.toggle("is-fixed")
                        }), 40)) : (h.fixed = !1, h.elm.classList.remove("is-fixed"))
                    }
                ...
                e(document).on("add.cards", (function(e) {
                    e.target !== document && !y.some((t => t === e.target)) && e.target.hasAttribute("mbr-data-bg-video") && (y.push(e.target), g(e.target))
                }))
            ...
            t && e(document).on("changeParameter.cards", (function(e, t, n, o) {
            ...
            })), document.querySelector("html").classList.add("mbr-site-loaded"), window.dispatchEvent(new CustomEvent("resize")), window.dispatchEvent(new CustomEvent("scroll")), t || document.addEventListener("click", (function(e) {
                try {
                    var t = e.target;
                ...
                function i() {
                    if (t.style.width = "", t.style.maxWidth = "", t.style.marginLeft = "", r && o) {
                        var i = r / o;
                        e.style.position = "absolute", e.style.top = "0", e.style.left = "0", e.style.right = "0", e.style.bottom = "0";
                        var s = a(n) / l(n);
                        if (s > i) {
                            var c = 100 * (s - i) / i;
                            t.style.width = c + 100 + "%", t.style.maxWidth = c + 100 + "%", t.style.marginLeft = -c / 2 + "%"
                        }
                    }
                }
            ...
            if (!d() && document.querySelectorAll("input[name=animation]").length) {
                ...
                function t() {
                    ...
                    e.forEach((function(e) {
                        ...
                        (i + r >= n && i - 50 <= o || function(e) {
                            ...
                            if (!t) return !1;
                            if (t.querySelectorAll(".carousel-item.active .hidden.animate__animated").length) return !1;
                            ...
                            return !0
                        }(e)) && e.classList.contains("hidden") && (e.classList.remove("hidden"), e.classList.add("animate__fadeIn"), e.classList.add("animate__delay-1s"), e.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", (function() {
                    ...
                    if (!e.parents().filter((function(e) {
                            if (e.matches("a, p, .navbar, .mbr-arrow, footer, .iconbox, .mbr-slider, .mbr-gallery, .mbr-testimonial .card-block, #cookiesdirective, .mbr-wowslider, .accordion, .tab-content, .engine, #scrollToTop, .modal, .item")) return !0
                        })).length) return !0
                }))).filter((function(e) {
                ...
                })), window.addEventListener("scroll", t), window.addEventListener("resize", t), window.dispatchEvent(new CustomEvent("scroll"))
            }
        }))), s((function() {
            if (document.querySelectorAll(".mbr-arrow-up").length) {
                ...
                e.style.display = "none", window.addEventListener("scroll", (function() {
                    ...
                    (document.documentElement.scrollTop || document.body.scrollTop) > n / 2 - document.documentElement.clientHeight / 2 || window.scrollY > window.innerHeight ? ((t = e).style.display = "block", function e() {
        ...
        m && m.addEventListener("click", (function(e) {
            ...
            t.classList.contains("engine") && (t = t.closest("section").nextElementSibling), window.scrollTo(0, i(t).top)
        }))
    }
    ...
    if (!t && (window.navigator.userAgent.indexOf("MSIE ") > 0 || navigator.userAgent.match(/Trident.*rv\:11\./)) && e(document).on("add.cards", (function(e) {
            ...
            if (!t) {
                var e = function(e) {
                        if (e.target) return "VIDEO" == e.target.tagName ? (e.preventDefault(), void e.stopPropagation()) : void n(e.target)
                    },
                    n = function(t) {
                        ...
                        if (t.parents("section").forEach((function(e) {
                            ...
                            if (-1 !== o.indexOf("youtu") && n.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*"), -1 !== o.indexOf("vimeo")) {
                        ...
                        a.style.display = "table", a.addEventListener("click", (function(t) {
                            if ("VIDEO" !== t.target.tagName) {
                                if (o) - 1 !== o.indexOf("youtu") && n.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), -1 !== o.indexOf("vimeo") && r.pause();
                                else {
                                    let e = n.parentNode.querySelector("video");
                                    e && e.pause && e.pause()
                                }
                                a.style.display = "none", a.removeEventListener("click", e), i.style.zIndex = "0"
                            }
                        }))
                    };
                document.querySelectorAll(".modalWindow-video > iframe").forEach((function(e) {
                    ...
                    if (t) {
                        ...
                        if (-1 !== t.indexOf("youtu")) e.setAttribute("src", "https://youtube.com/embed/" + n[6] + "?rel=0&enablejsapi=1");
                        else if (-1 !== t.indexOf("vimeo")) e.setAttribute("src", "https://player.vimeo.com/video/" + n[6] + "?autoplay=0&loop=0");
                            ...
                            o && n.setAttribute("poster", o.src), n.setAttribute("controls", ""), n.setAttribute("playsinline", ""), n.setAttribute("loop", ""), n.setAttribute("src", t), e.style.display = "none", n.style.width = "100%", e.after(n)
                        }
                    }
        ...
        if (e.forEach((e => {
            ...
            })), t.forEach((e => e.classList.remove("show"))), n.forEach((e => e.classList.remove("open"))), !d()) {
    ...
    function y(e) {
        ...
        null === t.getAttribute("id") && (n = t.classList.value.match(/cid-.*?(?=\s|$)/) + "-carousel"), t.querySelectorAll(".carousel").forEach((function(e) {
            e.setAttribute("id", n)
        })), t.querySelector(".carousel-controls") && t.querySelectorAll(".carousel-controls").forEach((function(e) {
            e.querySelectorAll("a").forEach((function(e) {
                e.setAttribute("href", "#" + n), o ? e.setAttribute("data-bs-target", "#" + n) : e.setAttribute("data-target", "#" + n)
            }))
    ...
    if (t || (void 0 === window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach((function(e) {
            var t, n, o;
            e.getAttribute("data-isinit") || (y(e), n = (t = e).querySelectorAll(".carousel-item").length, o = t.querySelector(".carousel-inner").getAttribute("data-visible"), n < o && (o = n), t.querySelectorAll(".carousel-inner").forEach((function(e) {
                ...
                for (var t = e, n = 1; n < o; n++) {
                    ...
                    i.classList.add("cloneditem-" + n), i.classList.add("clonedCol"), i.setAttribute("data-cloned-index", r), e.children[0].appendChild(i)
                }
            })))
            ...
            y(e)
        }))), void 0 === window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0, s((function() {
            ...
            e.addEventListener("click", (function() {
                ...
                if (n.classList.contains("collapsing") && (-1 != t.indexOf("toggle") || -1 != t.indexOf("accordion")) && (e.classList.contains("collapsed") ? (o.classList.remove("mbri-arrow-up"), o.classList.add("mbri-arrow-down")) : (o.classList.remove("mbri-arrow-down"), o.classList.add("mbri-arrow-up")), -1 != t.indexOf("accordion"))) {
            ...
            n.addEventListener("slide.bs.carousel", (function() {
                ...
                r.forEach((function(e) {
                    ...
                    keyboard: !0
                }), n.querySelectorAll(".carousel-item.active").length > 1 && (n.querySelectorAll(".carousel-item.active")[1].classList.remove("active"), n.querySelectorAll(".carousel-control li.active")[1].classList.remove("active"))
            }))
        }))), t) {
        if (!o) return;
        e(document).on("add.cards", (function(t) {
    ...
    function v(e, t, n) {
        ...
        o.getAttribute("style") || o.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;"), r.contains("row") && (r.remove("row"), r.add("media-container-row")), e.querySelectorAll(".svg-gradient > *").forEach((function(e) {
            e.setAttribute("id", t)
        }));
        var i = e.cloneNode(!0);
        Array.from(e.children).forEach((function(e) {
            if ("SVG" !== e.tagName) return e.remove()
        })), e.setAttribute("data-pie", `{ ${function(e){var t="",n=e.querySelector("svg linearGradient");if(n){for(var o=[],r=Array.from(n.children),i=0;i<r.length;i++)o.push(`"${r[i].getAttribute("stop-color")}"`);t=`"lineargradient": [${o}],`,Array.from(e.querySelectorAll("svg")).some((function(e){return e.classList.contains("svg-gradient")}))||e.querySelectorAll("svg").forEach((function(e){e.classList.add("svg-gradient")}))}return t}(e.closest("section"))} "percent": ${n}, "size": 150, "colorCircle": "#f1f1f1", "stroke": 5, "colorSlice": "url(#${t})", "fontSize": "1.3rem", "number": false }`), Array.from(i.children).forEach((function(t) {
            switch (!0) {
                case t.matches("p"):
    ...
    function w() {
        ...
        const e = t => {
            ...
            if (r) {
                ...
                a(), t.style.cssText = "position: relative; display: inline-flex; white-space: nowrap;", t.children[1].style.cssText = `position: absolute; left: ${100*-i}%;`;
                const l = () => {
                        var e, r, a;
                        n.target += o, n.current = (e = n.current, r = n.target, e * (1 - (a = .2)) + r * a), n.target > 100 && (n.current -= n.target, n.target = 0);
                        const s = n.current * i;
    ...
    })), t ? e(document).on("add.cards", w) : window.addEventListener("DOMContentLoaded", w), t ? e(document).on("add.cards", E) : window.addEventListener("DOMContentLoaded", E)
}();