/*! @vimeo/player v2.14.1 | (c) 2020 Vimeo | MIT License | https://github.com/vimeo/player.js */ ! function(e, t) {
    ...
    function d(e, t, n) {
        ...
        var o = r[t].indexOf(n);
        return -1 !== o && r[t].splice(o, 1), c.set(e.element, r), r[t] && 0 === r[t].length
    }
            ...
            l.open("GET", a, !0), l.onload = function() {
                if (404 !== l.status)
                    if (403 !== l.status) try {
                        ...
                        if (403 === t.domain_status_code) return m(t, n), void i(new Error("“".concat(e, "” is not embeddable.")));
                        o(t)
                    } catch (e) {
                        i(e)
    ...
    function w(e, t) {
        var n, r = [];
        if ((t = y(t)).event) {
            if ("error" === t.event) f(e, t.data.method).forEach((function(n) {
        ...
        T = function() {
            function t(e) {
                ...
                if (function(e, t) {
                    ...
                    }(this, t), window.jQuery && e instanceof jQuery && (e.length > 1 && window.console && console.warn && console.warn("A jQuery object with multiple elements was passed, using the first element."), e = e[0]), "undefined" != typeof document && "string" == typeof e && (e = document.getElementById(e)), ! function(e) {
                    ...
                    if (n._onMessage = function(e) {
                            if (r(e.origin) && n.element.contentWindow === e.source) {
                                ...
                                var u = o && "ready" === o.event,
                                    l = o && "ping" === o.method;
                                if (u || l) return n.element.setAttribute("data-ready", "true"), void t();
                                w(n, o)
                            }
                        ...
                        p(o(u), u, e).then((function(t) {
                            var r, o, i, a = m(t, e);
                            return n.element = a, n._originalElement = e, r = e, o = a, i = c.get(r), c.set(o, i), c.delete(r), b.set(n.element, n), t
                        })).catch(a)
                    }
                }));
                if (k.set(this, u), b.set(this.element, this), "IFRAME" === this.element.nodeName && g(this, "ping"), E.isEnabled) {
                    var f = function() {
                        return E.exit()
                    };
                    E.on("fullscreenchange", (function() {
                        E.isFullscreen ? s(n, "event:exitFullscreen", f) : d(n, "event:exitFullscreen", f), n.ready().then((function() {
            ...
            return i = t, a = [{
                ...
                value: function(e, t) {
                    ...
                    0 === f(this, "event:".concat(e)).length && this.callMethod("addEventListener", e).catch((function() {})), s(this, "event:".concat(e), t)
                }
            }, {
                key: "off",
                value: function(e, t) {
                ...
                value: function() {
                    ...
                    return new l((function(t) {
                        if (k.delete(e), b.delete(e.element), e._originalElement && (b.delete(e._originalElement), e._originalElement.removeAttribute("data-vimeo-initialized")), e.element && "IFRAME" === e.element.nodeName && e.element.parentNode && e.element.parentNode.removeChild(e.element), e.element && "DIV" === e.element.nodeName && e.element.parentNode) {
