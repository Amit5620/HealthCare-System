        ...
        function l() {
            ...
            if (l >= d) {
                ...
                if (m) {
                    ...
                    })), g >= 8 && !t.classList.contains("moving-left") && (m.m41 = -2e3), g >= 8 && !t.classList.contains("moving-left") && window.innerWidth < 1200 && (m.m41 = -900), !0) {
                        case g < 8:
                            c();
                ...
                if (w) {
                    ...
                    switch (u.forEach((n => {
                        n.querySelector("img").classList.remove("hidden")
                    })), W >= 8 && e.classList.contains("moving-left") && (w.m41 = -2e3), W >= 8 && !e.classList.contains("moving-left") && window.innerWidth < 1200 && (w.m41 = 0), !0) {
                        case W < 8:
                            c();
                ...
                if (h) {
                    ...
                    L.forEach((n => {
                        n.querySelector("img").classList.remove("hidden")
                    })), y >= 8 && !i.classList.contains("moving-left") && (h.m41 = -2e3), y >= 8 && !i.classList.contains("moving-left") && window.innerWidth < 1200 && (h.m41 = -900);
                    let v = h.m41 + .9 * (l - d);
                    ...
                    y < 8 && c(), i.classList.contains("moving-left") ? i.classList.contains("moving-left") && (y < 8 && c(), window.innerWidth >= 2560 ? v = h.m41 - .9 * (l - d) : window.innerWidth >= 1440 ? v = h.m41 - .55 * (l - d) : window.innerWidth >= 1024 ? v = h.m41 - .45 * (l - d) : window.innerWidth >= 768 ? v = h.m41 - .35 * (l - d) : window.innerWidth >= 320 && (v = h.m41 - .25 * (l - d))) : window.innerWidth >= 2560 ? v = h.m41 + .9 * (l - d) : window.innerWidth >= 1440 ? v = h.m41 + .55 * (l - d) : window.innerWidth >= 1024 ? v = h.m41 + .45 * (l - d) : window.innerWidth >= 768 ? v = h.m41 + .35 * (l - d) : window.innerWidth >= 320 && (v = h.m41 + .25 * (l - d)), i.style.transform = `translate3d(${v}px, 0, 0)`
                }
            }
        }
